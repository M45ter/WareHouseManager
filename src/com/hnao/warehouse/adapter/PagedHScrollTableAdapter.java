...
public interface PagedHScrollTableAdapter {
	 ...
	 */
	List<Map<Integer, List<String>>> getRows(final int startRow, final int endRow);
	...
	OnClickListener getCellOnClickListener(final int row, final int col);
}
